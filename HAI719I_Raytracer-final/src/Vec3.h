...
public:
    ...
    bool isBetween(Vec3 const & min_corner, Vec3 const & max_corner){

        if(mVals[0] > min_corner[0] and mVals[0] < max_corner[0] and
           mVals[1] > min_corner[1] and mVals[1] < max_corner[1] and
           mVals[2] > min_corner[2] and mVals[2] < max_corner[2]){
            /*std::cout << "corner is inside bb" << std::endl;
            std::cout << "corner: " << mVals[0] <<","<<mVals[1]<<","<<mVals[2]<<std::endl;
            ...
            //std::cout << "corner is not inside bb" << std::endl;
            return false;
        }
    }
};
